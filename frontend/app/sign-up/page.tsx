    ...
    return (
      <main className="relative min-h-screen overflow-hidden bg-background text-foreground">
        ...
        <div className="mx-auto flex max-w-md flex-col items-center px-4 pb-28 pt-20 sm:px-8 text-center">
          ...
          <h1 className="mt-6 text-2xl font-bold text-white">E-postanı kontrol et</h1>
          <p className="mt-3 text-sm leading-relaxed text-zinc-500">
            <span className="font-medium text-zinc-300">{email}</span> adresine bir doğrulama bağlantısı gönderdik. Bağlantıya tıklayarak hesabını aktif edebilirsin.
          </p>
          <Link
            href="/sign-in"
